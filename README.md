...
Published 0n 05/11/21 by Elijah LaLonde.
...
Snapshot POD is carried out for differnent numbers of images and the results are investigated. The condition number of the autocovariance matrix is also investigated.
...
Hypothesis:
  ...
  3. The next hypothesis to explore is how the modes correlate when using different numbers of images and consequently more modes. Does the energy distribution change? How well do        the modes correlate to each other?
